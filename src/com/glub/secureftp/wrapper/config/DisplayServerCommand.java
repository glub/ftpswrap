...
//*
//* $Id: DisplayServerCommand.java 39 2009-05-11 22:50:09Z gary $
//*
//*****************************************************************************
...
public class DisplayServerCommand extends Command {
  ...
  public DisplayServerCommand() {
    super("0", CommandID.DISPLAY_SERVER_COMMAND_ID, "Display server information");
  }
  ...
  private void listServer( int serverID, List serverList ) {
